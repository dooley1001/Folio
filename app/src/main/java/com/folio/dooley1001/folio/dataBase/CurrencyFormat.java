...
public class CurrencyFormat {
    ...
    private static CurrencyFormat sInstance;
    private Set<String> cryptoList;
    private DecimalFormat cryptoFormatter;


    private CurrencyFormat(Context context) {
        this.context = context;
        currencyFormatMap = new HashMap<>();
        //create hashset for our list of coins
        cryptoList = new HashSet<>();
        cryptoFormatter = new DecimalFormat("#,###.##########");
        addCryptos();
        buildHashMap();
    }
    //default list of cryptos
    private void addCryptos() {
        cryptoList.add("BTC");
        cryptoList.add("LTC");
        cryptoList.add("ETH");
    }
    //get the current instance passing in the context
    public static synchronized CurrencyFormat getInstance(Context context) {

        if (sInstance == null) {
            sInstance = new CurrencyFormat(context.getApplicationContext());
        }
        return sInstance;
    }
    ...
    // pair formatters put into a hash map
